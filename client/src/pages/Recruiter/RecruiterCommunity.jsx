...
const RecruiterCommunity = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <CommunityHeader onCreatePost={() => setCreateModalOpen(true)} />
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-12 text-center">
            ...
            <p className="mt-2 text-slate-500">
              Be the first recruiter to start a discussion.
            </p>
          </div>
        ) : (
          <div className="space-y-5">
            {posts.map((post) => (
              ...
              >
                ...
                <p className="mt-3 leading-7 text-slate-600">{post.content}</p>
